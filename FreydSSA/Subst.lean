...
theorem InstSet.Subst.ofWk_refl [Φ : InstSet φ (Ty α)]
  {Γ : Ctx ν (Ty α)} (hΓ : Γ.Nodup)
  : @ofWk _ _ _ Φ _ _ (Ctx.Wk.refl Γ) hΓ = Subst.id hΓ
  := by simp only [id, ofWk]; congr; funext i; congr; apply Ctx.Wk.allEq

-- theorem InstSet.Subst.wk_comp_wk [Φ : InstSet φ (Ty α)]
...
-- theorem InstSet.Subst.comp_wk [Φ : InstSet φ (Ty α)]
...
-- def InstSet.Tm.subst_comp [Φ : InstSet φ (Ty α)] {p : Purity}
...
-- theorem InstSet.Subst.comp_assoc [Φ : InstSet φ (Ty α)]
